...
describe('Request should succeed when performing a DELETE on an endpoint that returns a', () => {
  it('200 status code', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/200', { Accept: 'application/vnd.api+json' });
  ...
  it('201 status code', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/201', { Accept: 'application/vnd.api+json' });
  ...
  it('202 status code', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/202', { Accept: 'application/vnd.api+json' });
  ...
  it('203 status code', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/203', { Accept: 'application/vnd.api+json' });
  ...
  it('206 status code', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/206', { Accept: 'application/vnd.api+json' });
  ...
  it('299 status code', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/299', { Accept: 'application/vnd.api+json' });
  ...
  it('301 status code supporting redirects', async () => {
    ...
    const response = await restClient.Delete('https://httpstat.us/301', { Accept: 'application/vnd.api+json' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('302 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Delete('https://httpstat.us/302', { Accept: 'application/vnd.api+json' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('303 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Delete('https://httpstat.us/303', { Accept: 'application/vnd.api+json' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('305 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Delete('https://httpstat.us/305', { Accept: 'application/vnd.api+json' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('307 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Delete('https://httpstat.us/307', { Accept: 'application/vnd.api+json' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('308 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Delete('https://httpstat.us/308', { Accept: 'application/vnd.api+json' });
    expect(response.statusCode).toBe(200);
  });
});
...
describe('The MockRestClient should throw when a DELETE is performed', () => {
  it('without a response being mocked', async () => {
    try {
      const restClient = new MockRestClient();
      await restClient.Delete('https://httpstat.us/301', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
...
describe('Request should fail and throw when performing a DELETE on an endpoint that returns a', () => {
  ...
  it('302 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/302', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('303 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/303', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('304 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/304', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('305 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/305', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('306 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/306', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('307 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/307', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('308 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/308', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('399 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/399', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('400 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/400', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('401 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/401', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('402 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/402', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('403 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/403', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('404 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/404', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('405 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/405', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('406 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/406', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('407 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/407', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('408 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/408', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('409 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/409', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('410 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/410', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('411 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/411', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('412 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/412', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('413 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/413', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('414 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/414', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('415 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/415', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('416 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/416', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('417 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/417', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('418 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/418', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('421 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/421', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('422 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/422', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('428 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/428', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('429 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/429', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('431 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/431', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('451 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/451', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('499 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/499', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
      expect(error).toBeInstanceOf(Error520WebServerIsReturningAnUnknownError);
      const errorCode = 499;
      expect((error as Error520WebServerIsReturningAnUnknownError).status).toBe(errorCode);
  ...
  it('500 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/500', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('501 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/501', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('502 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/502', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('503 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/503', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('504 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/504', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('505 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/505', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('511 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/511', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('520 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/520', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
      expect(error).toBeInstanceOf(Error520WebServerIsReturningAnUnknownError);
      const errorCode = 520;
      expect((error as Error520WebServerIsReturningAnUnknownError).status).toBe(errorCode);
  ...
  it('522 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/522', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('524 status code', async () => {
    try {
      ...
      await restClient.Delete('https://httpstat.us/524', { Accept: 'application/vnd.api+json' }, { maxRedirects: 0 });
    } catch (error) {
