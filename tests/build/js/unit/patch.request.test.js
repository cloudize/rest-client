...
describe('Request should succeed when performing a PATCH on an endpoint that returns a', () => {
  it('200 status code', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/200', payload, { Accept: '*/*' });
  ...
  it('201 status code', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/201', payload, { Accept: '*/*' });
  ...
  it('202 status code', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/202', payload, { Accept: '*/*' });
  ...
  it('203 status code', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/203', payload, { Accept: '*/*' });
  ...
  it('206 status code', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/206', payload, { Accept: '*/*' });
  ...
  it('299 status code', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/299', payload, { Accept: '*/*' });
  ...
  it('301 status code supporting redirects', async () => {
    ...
    const response = await restClient.Patch('https://httpstat.us/301', payload, { Accept: '*/*' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('302 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Patch('https://httpstat.us/302', payload, { Accept: '*/*' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('303 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Patch('https://httpstat.us/303', payload, { Accept: '*/*' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('305 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Patch('https://httpstat.us/305', payload, { Accept: '*/*' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('307 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Patch('https://httpstat.us/307', payload, { Accept: '*/*' });
    expect(response.statusCode).toBe(200);
  });
  ...
  it('308 status code supporting redirects', async () => {
    const restClient = new MockRestClient();
    restClient.MockResolve({ statusCode: 200 });
    const response = await restClient.Patch('https://httpstat.us/308', payload, { Accept: '*/*' });
    expect(response.statusCode).toBe(200);
  });
});
...
describe('Request should fail and throw when performing a PATCH on an endpoint that returns a', () => {
  it('301 status code with no redirect', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/301', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('302 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/302', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('303 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/303', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('304 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/304', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('305 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/305', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('306 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/306', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('307 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/307', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('308 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/308', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('399 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/399', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('400 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/400', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('401 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/401', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('402 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/402', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('403 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/403', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('404 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/404', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('405 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/405', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('406 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/406', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('407 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/407', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('408 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/408', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('409 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/409', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('410 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/410', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('411 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/411', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('412 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/412', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('413 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/413', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('414 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/414', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('415 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/415', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('416 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/416', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('417 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/417', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('418 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/418', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('421 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/421', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('422 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/422', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('428 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/428', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('429 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/429', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('431 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/431', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('451 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/451', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('499 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/499', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
      expect(error).toBeInstanceOf(Error520WebServerIsReturningAnUnknownError);
  ...
  it('500 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/500', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('501 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/501', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('502 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/502', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('503 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/503', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('504 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/504', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('505 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/505', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('511 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/511', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('520 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/520', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
      expect(error).toBeInstanceOf(Error520WebServerIsReturningAnUnknownError);
  ...
  it('522 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/522', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
  ...
  it('524 status code', async () => {
    try {
      ...
      await restClient.Patch('https://httpstat.us/524', payload, { Accept: '*/*' }, { maxRedirects: 0 });
    } catch (error) {
